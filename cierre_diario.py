...
def guardar_en_sheets(nombre_hoja, df):
    try:
        ...
        try:
            ...
            return False, f"La hoja '{nombre_hoja}' no existe en tu archivo PCD_BaseDatos. ¡Créala primero!"
            
        # Preparar datos: Agregar fecha de registro al inicio
        ...
        return False, "Falta el archivo 'credenciales.json' en la carpeta."
